...
@section('content')
            ...
            <div class="container py-2">
                <div class="row g-5">
                    <div class="col-lg-12 col-md-12 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <h1 class="mb-4">{{ $divisi->nama_divisi}}</h1>
                        {!! $divisi->isi !!}
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                        <div class="h-100 position-relative">
                            <img src="{{ asset($divisi->img) }}" class="img-fluid w-80 rounded" alt="" style="margin-bottom: 25%;">
        ...
        <!-- Team Start -->
        <div class="container-fluid pb-1 mb-5 team">
            <div class="container pb-5">
                <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                    <h5 class="text-primary">Anggota</h5>
                    <h1></h1>
                </div>
